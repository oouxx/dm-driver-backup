...
const (
	...
	compressDef   = Dm_build_692
	compressIDDef = Dm_build_693
...
func (c *DmConnector) setAttributes(props *Properties) error {
	...
	c.bufPrefetch = props.GetInt(BufPrefetchKey, c.bufPrefetch, int(Dm_build_677), int(Dm_build_678))
...
func (c *DmConnector) connectSingle(ctx context.Context) (*DmConnection, error) {
	...
	if err = dc.Access.dm_build_389(); err != nil {
